...
class IngredientRecipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient_recipe" do
    assert_difference('IngredientRecipe.count') do
      post ingredient_recipes_url, params: { ingredient_recipe: { ingredient_id: @ingredient_recipe.ingredient_id, recipe_id: @ingredient_recipe.recipe_id } }
    end
  ...
  test "should update ingredient_recipe" do
    patch ingredient_recipe_url(@ingredient_recipe), params: { ingredient_recipe: { ingredient_id: @ingredient_recipe.ingredient_id, recipe_id: @ingredient_recipe.recipe_id } }
